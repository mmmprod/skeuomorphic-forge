...
.screw::after {
  ...
  background: #111; transform: rotate(var(--screw-angle, 30deg));
}
```
...
.vent-slat {
  ...
  box-shadow: 0 1px 0 rgba(255,255,255,0.03), inset 0 1px 2px rgba(0,0,0,0.8);
}
```
...
.rivet {
  ...
  box-shadow: inset 0 -1px 1px rgba(0,0,0,0.5), 0 1px 0 rgba(255,255,255,0.05);
}
```
