...
.scratched::after {
  ...
  background:
    linear-gradient(73deg, transparent 30%, rgba(255,255,255,0.03) 30.5%, transparent 31%),
    linear-gradient(108deg, transparent 50%, rgba(255,255,255,0.02) 50.3%, transparent 50.6%),
...
.worn-edge {
  ...
  box-shadow:
    inset 0 1px 0 rgba(255,255,255,0.15), /* exposed metal at edge */
