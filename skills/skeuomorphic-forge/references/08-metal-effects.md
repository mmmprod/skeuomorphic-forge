...
.metal {
  ...
  font: bold 6em/2em "Helvetica Neue", Arial, sans-serif;
  text-align: center;
  color: hsla(0, 0%, 20%, 1);
  text-shadow:
    hsla(0, 0%, 40%, .5) 0 -1px 0,     /* Bottom shadow — text sits in groove */
    hsla(0, 0%, 100%, .6) 0 2px 1px;    /* Top highlight — light catches top edge */
  ...
  box-shadow:
    inset hsla(0,0%,15%,  1) 0  0px 0px 4px,  /* 1. Border — sharp dark edge */
    inset hsla(0,0%,15%, .8) 0 -1px 5px 4px,   /* 2. Soft inner shadow (bottom) */
    inset hsla(0,0%,0%, .25) 0 -1px 0px 7px,   /* 3. Bottom shadow deepening */
    inset hsla(0,0%,100%,.7) 0  2px 1px 7px,   /* 4. Top highlight — convex surface */
    hsla(0,0%, 0%,.15) 0 -5px 6px 4px,         /* 5. Outer shadow (above) */
    hsla(0,0%,100%,.5) 0  5px 6px 4px;         /* 6. Outer highlight (below) */
...
.metal.radial {
  ...
  background-image:
    ...
    /* Brush texture — 3 repeating radial layers at different frequencies */
    repeating-radial-gradient(50% 50%, 100% 100%,
      hsla(0,0%,0%,0) 0%, hsla(0,0%,0%,0) 3%, hsla(0,0%,0%,.1) 3.5%),
    repeating-radial-gradient(50% 50%, 100% 100%,
      hsla(0,0%,100%,0) 0%, hsla(0,0%,100%,0) 6%, hsla(0,0%,100%,.1) 7.5%),
    repeating-radial-gradient(50% 50%, 100% 100%,
      hsla(0,0%,100%,0) 0%, hsla(0,0%,100%,0) 1.2%, hsla(0,0%,100%,.2) 2.2%),

    /* Base curvature — center-to-edge darkening */
    radial-gradient(50% 50%, 200% 50%,
...
.metal.radial::after {
  ...
  background-image:
    ...
    radial-gradient(100%  50%, 50%  6%, hsla(0,0%,0%,.1) 0%, hsla(0,0%,0%,0) 100%);
}
...
.metal.linear {
  ...
  background-image:
    ...
    repeating-linear-gradient(left,
      hsla(0,0%,100%,0) 0%, hsla(0,0%,100%,0) 6%, hsla(0,0%,100%,.1) 7.5%),
    repeating-linear-gradient(left,
      hsla(0,0%,0%,0) 0%, hsla(0,0%,0%,0) 4%, hsla(0,0%,0%,.03) 4.5%),
    repeating-linear-gradient(left,
      hsla(0,0%,100%,0) 0%, hsla(0,0%,100%,0) 1.2%, hsla(0,0%,100%,.15) 2.2%),

    /* Curvature — vertical gradient light-dark-light */
...
.metal-button-gold {
  ...
  box-shadow:
    inset 0 0 0 1px #eedc00,                              /* Inner ring */
    inset 0 1px 2px rgba(255, 255, 255, 0.5),             /* Top highlight */
    inset 0 -1px 2px rgba(0, 0, 0, 0.5);                  /* Bottom shadow */
  ...
  background:
    ...
    /* Border fill — solid gold */
    linear-gradient(#f6d600, #f6d600) padding-box,

    /* Ground shadow — radial below button */
    radial-gradient(
      rgba(120, 120, 120, 0.9),
      rgba(120, 120, 120, 0) 70%
    ) 50% bottom / 80% 7.5% no-repeat border-box;
}
```
...
.metal-button-silver {
  ...
  background:
    ...
    radial-gradient(rgba(120,120,120,.9), rgba(120,120,120,0) 70%)
      50% bottom / 80% 7.5% no-repeat border-box;
}
```
...
```css
.metal-button-bronze {
  box-shadow: inset 0 0 0 1px #bc7e6b,
    inset 0 1px 2px rgba(255, 255, 255, 0.5),
    inset 0 -1px 2px rgba(0, 0, 0, 0.5);
...
.metal-button-rosegold {
  box-shadow: inset 0 0 0 1px #c7aca0,
    inset 0 1px 2px rgba(255, 255, 255, 0.5),
    inset 0 -1px 2px rgba(0, 0, 0, 0.5);
...
.chrome-text {
  ...
  background: linear-gradient(180deg,
    ...
    #c0c0c0 30%,     /* Upper mid-tone */
    #999999 45%,     /* Shadow band */
    #ffffff 50%,     /* Central specular (bright reflection) */
    #666666 65%,     /* Lower shadow */
    #ffffff 95%      /* Bottom edge catch */
  );
...
.border-gold {
  ...
  background:
    ...
    linear-gradient(45deg,
      #f6dba6, #ffebc4, #f0be79,
      #8f653b, #673d22, #ba7f3b, #eebc70
    ) border-box;
}
```
...
.border-silver {
  ...
  background:
    linear-gradient(45deg, #000, #000) padding-box,
    linear-gradient(45deg,
      #C1A4E8, #B8E2FB, #F2EFE8,
      #F9DCDD, #E1C1E5, #BDAFE3
    ) border-box;
}
```
...
.border-bronze {
  ...
  background:
    linear-gradient(45deg, #000, #000) padding-box,
    linear-gradient(45deg,
      #F0CAB2, #A47C6C, #7F5B4A, #AC836D, #AB836E
    ) border-box;
}
```
...
.border-platinum {
  ...
  background:
    linear-gradient(45deg, #000, #000) padding-box,
    linear-gradient(45deg,
      #e5e4e2, #ffffff, #e5e4e2, #ffffff, #e5e4e2
    ) border-box;
}
```
...
.border-black {
  ...
  background:
    linear-gradient(45deg, #000, #000) padding-box,
    linear-gradient(45deg,
      #E7E7E7, #A1A19F, #706F6B,
      #2D2C29, #63625D, #76756E
    ) border-box;
}
```
