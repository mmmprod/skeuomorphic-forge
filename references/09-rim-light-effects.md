...
.card {
  ...
  box-shadow:
    ...
    /* 2. DIRECTIONAL rim — top strongest, bottom weakest */
    0 -1px 3px rgba(255,240,220,0.08),   /* top rim (strongest) */
    1px 0 2px rgba(255,240,220,0.04),    /* right rim (weaker) */
    -1px 0 2px rgba(255,240,220,0.04),   /* left rim (weaker) */
    0 1px 2px rgba(255,240,220,0.02);    /* bottom rim (weakest) */
}
