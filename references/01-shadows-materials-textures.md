...
```css
background: linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.15) 2%, transparent 4%,
  transparent 96%, rgba(255,255,255,0.08) 98%, transparent 100%);
```

### Backlit panel glow
```css
box-shadow: 0 0 20px rgba(var(--glow-color), 0.15),
...
box-shadow: 0 0 8px #ffb400, 0 0 16px rgba(255,180,0,0.4), 0 0 32px rgba(255,140,0,0.15);
```

### Green indicator
```css
background: radial-gradient(circle, #00ff41 0%, #00cc33 60%, transparent 100%);
box-shadow: 0 0 8px #00ff41, 0 0 16px rgba(0,255,65,0.4), 0 0 32px rgba(0,204,51,0.15);
```

### Red warning
```css
background: radial-gradient(circle, #ff3333 0%, #cc0000 60%, transparent 100%);
box-shadow: 0 0 8px #ff3333, 0 0 16px rgba(255,51,51,0.4), 0 0 32px rgba(204,0,0,0.15);
```

### Blue power
```css
background: radial-gradient(circle, #4488ff 0%, #2266dd 60%, transparent 100%);
box-shadow: 0 0 8px #4488ff, 0 0 16px rgba(68,136,255,0.4), 0 0 32px rgba(34,102,221,0.15);
```
