...
.chassis-bezel {
  ...
  box-shadow:
    ...
    inset 0 1px 0 rgba(255,255,255,0.12),    /* top catch */
    inset 0 -1px 0 rgba(0,0,0,0.5),          /* bottom shadow */
    inset 1px 0 0 rgba(255,255,255,0.06),     /* left catch */
    inset -1px 0 0 rgba(0,0,0,0.3),           /* right shadow */
    /* Outer depth — panel sitting on surface */
...
.brushed-horizontal {
  background:
    ...
    /* Base metal gradient */
    linear-gradient(145deg, #2a2a2a 0%, #1a1a1a 50%, #222222 100%);
}
```
...
.anodized-dark-blue {
  background:
    ...
    linear-gradient(145deg, #1a1a2e 0%, #12122a 50%, #1a1a30 100%);
}
```
...
.hex-perforation {
  ...
  background-image:
    radial-gradient(circle, var(--hole-color) var(--hole), transparent var(--hole)),
    radial-gradient(circle, var(--hole-color) var(--hole), transparent var(--hole));
  background-size:
...
.hex-perforation::after {
  ...
  background-image:
    radial-gradient(circle,
      transparent calc(var(--hole) - 1px),
      rgba(255,255,255,0.06) var(--hole),
      transparent calc(var(--hole) + 1px)
    ),
    radial-gradient(circle,
      transparent calc(var(--hole) - 1px),
...
.panel-seam-h::after {
  ...
  box-shadow:
    0 1px 0 rgba(255,255,255,0.05),  /* bottom catch */
    0 -1px 0 rgba(0,0,0,0.3);        /* top shadow */
}
```
...
.panel-seam-v::after {
  ...
  box-shadow:
    1px 0 0 rgba(255,255,255,0.05),  /* right catch */
    -1px 0 0 rgba(0,0,0,0.3);        /* left shadow */
}
```
...
.torx-screw {
  ...
  background: radial-gradient(circle at 35% 30%,
    #666 0%,           /* specular highlight */
    #444 20%,          /* mid tone */
    #2a2a2a 60%,       /* body */
    #1a1a1a 85%,       /* edge shadow */
    #111 100%          /* rim */
  );

  /* Depth — screw sits in a countersink */
  box-shadow:
    inset 0 1px 1px rgba(255,255,255,0.15),  /* dome highlight */
    inset 0 -1px 1px rgba(0,0,0,0.5),        /* bottom shadow */
    0 1px 2px rgba(0,0,0,0.5),               /* cast shadow */
    0 0 0 1px rgba(0,0,0,0.3);               /* countersink rim */
}
...
.stamped-label {
  ...
  text-shadow:
    0 1px 0 rgba(255,240,220,0.12);  /* highlight BELOW = raised above surface */
}
```
...
.engraved-label {
  ...
  text-shadow:
    0 1px 0 rgba(255,240,220,0.1),   /* highlight BELOW = light hitting bottom of groove */
    0 -1px 0 rgba(0,0,0,0.3);        /* shadow ABOVE = top edge casting shadow */
}
```
...
.silk-label {
  ...
  text-shadow:
    0 0 1px rgba(0,0,0,0.8),         /* ink spread shadow */
    0 1px 2px rgba(0,0,0,0.3);       /* paint thickness shadow */
}
```
...
.chassis {
  ...
  background:
    ...
    /* Base gradient */
    linear-gradient(150deg, #2a2a30 0%, #1e1e24 50%, #222228 100%);
  background-blend-mode: overlay, normal;
...
.sub-panel {
  background:
    ...
    linear-gradient(145deg, #222222 0%, #1a1a1a 100%);
  border-radius: 6px;
